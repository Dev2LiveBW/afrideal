...
export const EVENTS = {
  ...
  PAYABLE_RAISED: 'PAYABLE_RAISED',
  PAYABLE_SETTLED: 'PAYABLE_SETTLED',
  PAYABLE_CANCELLED: 'PAYABLE_CANCELLED',
  ...
  SOURCING_ACCEPTED: 'SOURCING_ACCEPTED',
  SOURCING_QUOTED: 'SOURCING_QUOTED',
  SOURCING_ADVANCED: 'SOURCING_ADVANCED',
